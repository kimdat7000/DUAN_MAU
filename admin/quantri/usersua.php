...
<div class="container">
    <div class="column">
        <form action="admin.php?page=userluu" method="post" onsubmit="return validateForm()">
            ...
            <input name="diachi" type="text" value="<?=$diachi?>"> <br>
            ...
            <input type="number" min=0 max=1 name="role" value="<?=$role?>"><br>
                <br>
                <input type="hidden" name="id" value="<?=$id?>"><br>
            <input type="submit" name="capnhat" id="" value="Sửa">
        </form>
    </div>
<div class="column">
    <table border="1">
